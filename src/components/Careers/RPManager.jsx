...
const [validmessage, setValidMessage] = useState("");
  ...
  return (
    <div className="">
        <Template name = "Careers" fname = "/Regional Program Manager"/>
                ...
                <div className="top">
                    <div className="left">
                        ...
                        <div className="rpinfo">
                            <div className="date">Started Oct 27, 2022</div> <div>|</div> <div className="application">20 Applicants</div>
                        </div>
                        <br />
                        ...
                        1. &nbsp; Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply dummy text of the printing and typesetting industry <br /> <br />
                        2. &nbsp; Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply dummy text of the printing and typesetting industry <br /> <br />
                    ...
                    <div className="right">
                        ...
                        <div className="recentJobs">
                            <div className="recentJobHeading">
                                Recent Jobs
                            </div>
                ...
                <div className="bottom">
                    ...
                    <div style={{
                        ...
                        <div className="consent">
                            ...
                            <div>I allow Alexis Enterprise to use my contact information to send me e-mail updates about Alexis Enterprise activities.</div>
                        </div>
